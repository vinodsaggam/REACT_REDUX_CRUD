    ...
    <>
      <Main title="Optima Health" >
        ...
        <Stack spacing={2} direction="column" sx={{ alignItems: 'center', pt: 4}}>
          <button type='submit' style={{ cursor: 'pointer', background: '#3D3635', fontWeight: '500', color: 'white', borderRadius: '15px', width: '100px', height: '50px' }}>Enter</button>
          <Link component="a" variant="body2" href='/' style={{ textAlign: 'center', cursor: 'pointer', color: '#3D3635', fontWeight: '500',textDecorationColor: '#3D3635', textDecorationThickness: '2px', borderRadius: '15px', width: '100px', height: '50px' }}> Cancel </Link>
        </Stack>
